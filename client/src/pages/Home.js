        ...
        <Center>
          <Box maxW="2400px">
            <Text px={8} pb={4}>
              ...
              reuse. Whether you're a thrifty parent or looking to reduce your
              environmental impact, Swapzie offers a family-friendly platform to
              swap or donate well-loved toys.
            </Text>
            <Text px={8} pb={4}>
        ...
        <Center>
          ...
          >
            ...
            <Text p={4}>
              ...
              the chosen person from your dashboard. Once they have claimed the
